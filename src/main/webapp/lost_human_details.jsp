...
<head>
    ...
    <title>Lost Human/Animal Details</title>
    <style>
        /* Same styling as product_details.jsp */
        body {
...
<body>
    <div class="container">
            ...
            if (itemId != null) {
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement(
                        "SELECT * FROM lost_humans_animals WHERE id = ?");
        ...
        <% if (rs.getString("photo") != null) { %>
            <img src="<%= rs.getString("photo") %>" class="item-image" 
        ...
        <div class="detail-row">
            ...
            <span class="detail-value"><%= rs.getString("owner_relation") != null ? rs.getString("owner_relation") : "N/A" %></span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Age:</span>
            <span class="detail-value"><%= rs.getString("age") != null ? rs.getString("age") : "N/A" %></span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Skin Tone:</span>
            <span class="detail-value"><%= rs.getString("skin_tone") != null ? rs.getString("skin_tone") : "N/A" %></span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Height:</span>
            <span class="detail-value"><%= rs.getString("height") != null ? rs.getString("height") : "N/A" %></span>
        </div>
        ...
        <div class="detail-row">
            ...
            <span class="detail-value"><%= rs.getString("last_seen_location") %></span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Last Seen Time:</span>
            <span class="detail-value"><%= rs.getString("last_seen_time") != null ? rs.getString("last_seen_time") : "N/A" %></span>
        </div>
        ...
        <div style="text-align: center;">
            <a href="view_lost_reports.jsp" class="back-link">← Back to Lost Items</a>
        </div>
        <%
                    } else {
